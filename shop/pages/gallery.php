...
while($data = mysqli_fetch_assoc($res)):?>
    <div class="product">
        ...
        <div class="product__content">
            <a href="index.php?page=product&id=<?= $data['id']?>" class="product__name"><?= ucfirst($data['title'])?></a>
            <p class="product__text"><?= $data['shortInfo']?></p>
            <p class="product__price"><?= number_format($data['price'],2, '.', '')?></p>
        </div>
        <button class="product__add" onclick="addToCart()" data-id="<?= $data['id']?>">
